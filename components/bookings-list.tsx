...
import { cancelBooking as cancelBookingAPI, deleteBookingAPI, updateBookingAPI } from "@/lib/api";
...
interface BookingsListProps {
  ...
  dateFilter?: string;
  onUpdateBooking?: (open: boolean) => void;
  onBookingIdChange?: (bookingId: string) => void;
  onDeleteBooking?: (open: boolean) => void;
}
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <CardTitle className="text-lg">
                    Table {booking.Table?.tableNumber || "N/A"}
                  </CardTitle>
                  <p className="text-sm text-muted-foreground">
